...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.monitoring_chart_type.addItem("")
        self.monitoring_chart_type.addItem("")  # Scatter
        self.monitoring_chart_type.setObjectName(u"monitoring_chart_type")
        self.monitoring_chart_type.setMinimumSize(QSize(110, 0))
        ...
        self.pcd_chart_type.addItem("")
        self.pcd_chart_type.addItem("")  # Scatter
        self.pcd_chart_type.setObjectName(u"pcd_chart_type")
        self.pcd_chart_type.setMinimumSize(QSize(110, 0))
        self.pcd_chart_type.setMaximumSize(QSize(110, 16777215))
    ...
    def retranslateUi(self, Form):
        ...
        self.monitoring_chart_type.setItemText(2, QCoreApplication.translate("Form", u"Scatter", None))
        ...
        self.pcd_chart_type.setItemText(2, QCoreApplication.translate("Form", u"Scatter", None))
